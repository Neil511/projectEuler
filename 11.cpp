...
// parse 2 digit string into an integer
int STOI(string s){
...
long long calculate(int arr [20][20], int a1, int a2, int b1, int b2, int c1, int c2, int d1, int d2){
  if((0 <= a1 && a1 < 20) && (0 <= a2 && a2 < 20) &&
    (0 <= b1 && b1 < 20) && (0 <= b2 && b2 < 20) &&
    (0 <= c1 && c1< 20) && (0 <= c2 && c2< 20) &&
    (0 <= d1 && d1 < 20) && (0 <= d2 && d2 < 20)) {
    return arr[a1][a2] * arr[b1][b2] * arr[c1][c2] * arr[d1][d2];
  }
  return 0;
}
